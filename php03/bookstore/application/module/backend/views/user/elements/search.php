...
$filterGroup	= Helper::cmsSelectbox('filter_group_id', $this->filterGroup, $this->arrParam['filter_group_id'], 'custom-select custom-select-sm mr-1', 'width: unset');
// Input
        ...
        <div class="row justify-content-between">
            ...
            <div class="mb-1">
                <form id="filter-bar" name="filter-bar" method="GET" action="">  
                    <?php echo $inputHiddenModule . $inputHiddenController . $inputHiddenAction . $filterGroup ;?>                        
                </form>
            </div>
